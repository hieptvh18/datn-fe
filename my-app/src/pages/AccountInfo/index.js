        ...
        <div className="surface-0 w-default m-auto my-8 px-6" style={{ fontFamily: 'var(--fontRoboto)' }}>
            ...
            <ul className="list-none p-0 m-0">
                <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
                    ...
                    <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{user.data?.name}</div>
                ...
                <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
                    ...
                    <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{user.data?.birthday}</div>
                    <div className="w-6 md:w-2 flex justify-content-end">
                ...
                <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
                    ...
                    <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{user.data?.gender == 2 ? "Nữ" : "Nam"}</div>
                    <div className="w-6 md:w-2 flex justify-content-end">
                ...
                <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
                    ...
                    <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{user.data?.phone}</div>
                    <div className="w-6 md:w-2 flex justify-content-end">
                ...
                <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
                    ...
                    <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">{user.data?.address}</div>
                    <div className="w-6 md:w-2 flex justify-content-end">
