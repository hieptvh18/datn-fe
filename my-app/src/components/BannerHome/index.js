...
const BannerHome = () => {
  return (
    <div
      style={{
        backgroundImage:
          "url(http://denticare.bold-themes.com/allen/wp-content/uploads/sites/16/2020/02/hero-2.jpg)",
      }}
      className="wrapper-banner-home"
    >
      <div className="w-default h-full m-auto flex align-items-center">
        <div className="content-banner-home">
          <h3 className="text-7xl font-light c-primary">
            Care For Your Smiler
          </h3>
          ...
          <div className="flex mt-8">
            <div className="flex column-gap-5">
              ...
              <div className="">
                ...
                <p className="text-img-icon-banner-home mt-3 text-500 list-decimal">
